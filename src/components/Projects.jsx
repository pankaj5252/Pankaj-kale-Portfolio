...
const Projects = () => {
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 text-center">
        {AllProjects.map((project, index) => (
          <Zoom key={index}>
            <div id={project.Name} className="bg-white shadow-xl rounded-lg p-4">
              <img
                src={typeof project.Image === 'object' ? Object.values(project.Image)[0] : project.Image || 'default-image-url'}
                alt={project.Name}
                className="w-full h-68 object-cover rounded-t-lg mb-4"
              />
